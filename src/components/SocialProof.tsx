...
import { HiUsers, HiTrendingUp, HiStar, HiLightningBolt } from 'react-icons/hi'
...
const SocialProof = () => {
  ...
  // Simula usuários online (gatilho de urgência/dopamina)
  useEffect(() => {
  ...
  return (
    <section className="py-20 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4" ref={ref}>
        {/* Active Users Badge (Gatilho de Escassez/Urgência) */}
        <motion.div
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-12">
          {socialStats.map((stat, index) => (
            ...
            >
              ...
              <div className="text-3xl md:text-4xl font-bold font-space gradient-text mb-1">
                {stat.value}
              </div>
              <div className="text-gray font-inter text-sm">{stat.label}</div>
            </motion.div>
          ))}
        </div>

        {/* Recent Activity (Gatilho de Prova Social) */}
        <motion.div
        ...
        >
          ...
          <motion.div
            key={currentActivity}
            className="mt-4 text-white font-inter text-lg"
        ...
        >
          {[
            ...
            <motion.div
              key={index}
              className="text-gray font-inter text-sm"
